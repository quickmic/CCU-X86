...
java -Dvertx.cacheDirBase=/tmp/.vertx-backuprestore -Dgnu.io.rxtx.SerialPorts=/dev/mmd_hmip -cp /opt/HMServer/HMIPServer.jar de.eq3.ccu.server.ip.validation.ValidateHmIPBackup /etc/crRFD.conf $pathBackup 
